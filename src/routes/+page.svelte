...
> 
  ...
  <a
    ...
    class="mt-8 p-1 sm:text-lg font-bold text-black transition-all rounded-sm shadow-sm bg-white/50 dark:bg-white/80 ring-1 ring-gray-900/5  hover:shadow-lg active:shadow-sm"
    id="djx"
  >
    @d3j1x
  </a>
